            ...
            window.onload = function () {
                var R = Raphael(0, 0, "100%", "100%"),
                    ...
                    number_line_start = R.text('17%', String(line_height+2)+'%', '1').attr({fill: '#fff'}),
                    number_line_end = R.text('83%', String(line_height+2)+'%', '100').attr({fill: '#fff'}),
                    hidden_number_dot = R.circle('70%', String(line_height+.2)+'%', 3).attr({fill: 'red'}),
                    hidden_number = R.text('70%', String(line_height+2)+'%', '82').attr({fill: '#fff'}),
                    ...
                    r = R.rect(.10*w,(line_height-40)*.01*h,.25*nll,30,10).attr({fill: "hsb(.35,.4,.4)", stroke: "white", opacity: .5,}).data('eff', 1).data('beta',.5).data('pos', [100,100]),
                ...
                textBoxButtonClick = function()
                {
                   ...
                   if (cntr<3)
                    {
                        alert('Please finish following the instructions on the top of the screen.');
                    }
                    else
                    {
                        window.location.href = 'http://198.61.169.95/pedro/js/instructions4.html';
                        ...
                        for (var i=0; i < scanners.length; i++)
                        {
                            if (isScannerOnLine(scanners[i])==true)
                            {
                                ...
                                if (cntr==0)
                                {
                                    ...
                                    setTimeout(function()
                                    {
                                    alert('Hmm. This scanner isn\'t so reliable, either. It thinks the number is there, but it\'s not. Click \'OK\', move the scanner to another point on the number line (not above the target number), and scan again.');
                                    }, 700);
                                    cntr +=1;
                                }
                                else if (cntr==1)
                                {
                                    scanners[i].glow({color: "hsb(.6, 1, 1)", width: 5});
                                    setTimeout(function()
                                    {
                                    alert('Ok, this time the scanner gave you the right signal; it turned blue, and blue means\
                                        the number\'s not under the scanner.\
                                        Press \'OK\' and scan a few more times; you can even move the scanner to another \
                                        spot on the line. You\'ll see that sometimes you get a red signal and sometimes a blue one.\
                                         This is because this scanner is not very reliable.');
                                    }, 700);
                                    cntr +=1;
                                }
                                else if (cntr<15)
                                ...
                                {
                                    alert("Great! Now let's continue the tutorial.");
                                    window.location.href = 'http://198.61.169.95/pedro/js/instructions5.html';
                                }
                            }
                        }
