            ...
            window.onload = function () {
                ...
                textBoxButtonClick = function()
                {
                        ...
                        setTimeout(function()
                        {
                            window.location.href = 'http://198.61.169.95/pedro/js/index.html';
                    ...
                    if (scanners_on_line == 1) //This is the correct number of scanners to have on line. Scan.
                    {
                        for (var i=0; i < scanners.length; i++)
                        {
                            if (isScannerOnLine(scanners[i])==true)
                            {
                                ...
                                setTimeout(function()
                            {
                                alert('When the scanner finds a number, it glows red.');
                                window.location.href = 'http://198.61.169.95/pedro/js/instructions3.html'
