            ...
            window.onload = function () {
                ...
                var tmpscanners = makeScanners([efficacies[0][parent.topframe.familiarization_order[3]]], [efficacies[1][parent.topframe.familiarization_order[3]]]);
                var r = tmpscanners[0];
                var scanners = [r];
                    ...
                    if (scanners_on_line == 1) //This is the correct number of scanners to have on line. Scan.
                    {
                        for (var i=0; i < scanners.length; i++)
                        {
                            if (isScannerOnLine(scanners[i])==true)
                            {
                                ...
                                //FORCE MOVE-ON
                                parent.topframe.top_index++;
                                parent.topframe.document.getElementById("tutorial").innerHTML = "<p>Whenever you think you've gotten a good sense for how well this scanner works, press 'next' to move on.</p>";
                                }
                            }
